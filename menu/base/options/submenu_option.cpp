...
void submenu_option::render(int position) {
	...
	if (!m_disable_icon) {
		if (m_override.m_enabled) {
			...
			menu::renderer::draw_sprite_aligned({ "Purge", "arrowright" }, { global::ui::g_position.x + global::ui::g_submenu_arrow_position.x - (0.23f - global::ui::g_scale.x), global::ui::g_position.y + (position * global::ui::g_option_scale) + global::ui::g_submenu_arrow_position.y }, global::ui::g_submenu_arrow_scale, 0.f, bar_color);
		}
	}
