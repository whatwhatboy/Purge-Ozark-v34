...
void number_option<Type>::render(int position) {
	...
	switch (m_type) {
		case TOGGLE:
			menu::renderer::draw_sprite({ "Purgetextures", "toggle_circle.png" }, { global::ui::g_position.x + global::ui::g_toggle_position.x - (0.23f - global::ui::g_scale.x), (global::ui::g_position.y + global::ui::g_toggle_position.y) + (position * global::ui::g_option_scale) }, global::ui::g_toggle_scale, 0.f, *m_toggle ? global::ui::g_toggle_on : global::ui::g_toggle_off);
	...
	if (m_requirement() && menu::input::is_option_pressed()) {
		...
		switch (m_type) {
			...
			case SCROLL:
				...
				native::display_onscreen_keyboard(0, "Purge", "", "", "", "", "", 10);
				break;
		}
