...
void toggle_option::render(int position) {
	...
	menu::renderer::draw_sprite({ "timerbars", "circle_checkpoints" }, { global::ui::g_position.x + global::ui::g_toggle_position.x - (0.23f - global::ui::g_scale.x), global::ui::g_position.y + global::ui::g_toggle_position.y + (position * global::ui::g_option_scale) }, global::ui::g_toggle_scale, 0.f, toggle_color);
}
