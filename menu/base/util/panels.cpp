...
#undef DrawText
	...
	math::vector2<float> panel_manager::render_panel_clock(panel_child& _this) {
		...
		menu::renderer::draw_sprite({ "Purgetextures", "clock_hand.png" }, { _x, _y }, { second_bar_width, second_bar_width * 2.f }, second_rotation, { 255, 0, 0, 255 });
		menu::renderer::draw_sprite({ "Purgetextures", "clock_hand.png" }, { _x, _y }, { minute_bar_width, minute_bar_width * 2.f }, minute_rotation, { 255, 255, 255, 255 });
		menu::renderer::draw_sprite({ "Purgetextures", "clock_hand.png" }, { _x, _y }, { hour_bar_width, hour_bar_width * 2.f }, hour_rotation, { 255, 255, 255, 255 });
		menu::renderer::draw_sprite({ "Purgetextures", "clock.png" }, { _x, _y }, { 0.1f, 0.18f }, 0.f, { 255, 255, 255, 255 });
