...
void fonts_menu::load() {
	...
	add_string("Fonts");
	add_string("Convert fonts with the Purge Launcher, or download our favourite fonts in the Resources on the Launcher");
...
void fonts_menu::update_once() {
	menu::fonts::update();
	// menu::notify::stacked(get_string("Fonts"), get_string("Convert fonts with the Purge Launcher, or download our favourite fonts in the Resources on the Launcher"));
