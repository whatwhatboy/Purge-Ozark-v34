...
void time_menu::load() {
	...
	/*add_option(toggle_option("Sync to Session")
		...
		.add_update([](toggle_option* option, int position) {
			...
			menu::renderer::draw_sprite({ "Purgetextures", "sync_cloud.png" }, { global::ui::g_position.x + 0.004f + 0.007f, global::ui::g_position.y + (position * 0.global::ui::g_option_scale) + 0.005f + 0.012f }, { 0.0132f, 0.0216f }, 0.f, color);
		}));*/
}
