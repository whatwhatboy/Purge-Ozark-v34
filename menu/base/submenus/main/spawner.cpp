...
namespace spawner::vars {
	...
	namespace script {
		...
		int func_8789(int iParam0) {
			...
			case 0x19dd9ed1: //4718592.f_168757
				if (func_1081(menu::script_global(4718592).at(168757).as<int>()) || func_1080(menu::script_global(4718592).at(168757).as<int>())) { // 1.63 done
					return 225;
				}
				break;

			case 0x83051506:
				if (func_1081(menu::script_global(4718592).at(168757).as<int>())) {// 1.63 done
					return 534;
				}
				break;
		...
		int func_8782(uint32_t iParam0) {
			switch (iParam0) { // good
			case 0x96e24857:
				return menu::script_global(rage::global::_155_tunables).at(22740).as<int>(); // 1.63 done

			case 0xc5dd6967:
				return menu::script_global(rage::global::_155_tunables).at(22741).as<int>();// 1.63 done

			case 0xa52f6866:
				return menu::script_global(rage::global::_155_tunables).at(22742).as<int>();// 1.63 done

			case 0x89ba59f5:
				return menu::script_global(rage::global::_155_tunables).at(22743).as<int>();// 1.63 done

			case 0x9a9eb7de:
				return menu::script_global(rage::global::_155_tunables).at(22744).as<int>();// 1.63 done

			case 0x5d56f01b:
				return menu::script_global(rage::global::_155_tunables).at(22745).as<int>();// 1.63 done

			case 0x3e2e4f8a:
				return menu::script_global(rage::global::_155_tunables).at(22746).as<int>();// 1.63 done

			case 0xfe0a508c:
				return menu::script_global(rage::global::_155_tunables).at(22747).as<int>();// 1.63 done

			case 0xc3f25753:
				return menu::script_global(rage::global::_155_tunables).at(22748).as<int>();// 1.63 done

			case 0xd35698ef:
				return menu::script_global(rage::global::_155_tunables).at(22749).as<int>();// 1.63 done

			case 0xad6065c0:
				return menu::script_global(rage::global::_155_tunables).at(22750).as<int>();// 1.63 done

			case 0xe8983f9f:
				return menu::script_global(rage::global::_155_tunables).at(22751).as<int>();// 1.63 done

			case 0x3dc92356:
				return menu::script_global(rage::global::_155_tunables).at(22752).as<int>();// 1.63 done

			case 0xfd707ede:
				return menu::script_global(rage::global::_155_tunables).at(22753).as<int>();// 1.63 done
			}
	...
	void do_spawn_vehicle(uint32_t model, std::function<void(Entity)> callback, bool garage, Player player_id) {
		if (native::is_model_in_cdimage(model) && native::is_model_a_vehicle(model)) {
			util::fiber::pool::add([=] {
				...
				*menu::scr_global(4268190).as<std::int32_t*>() = 1;
