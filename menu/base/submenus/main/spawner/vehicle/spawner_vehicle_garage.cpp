...
namespace spawner::vehicle::garage::vars {
	...
	namespace scripts {
		...
		int func_607(int iParam0) {
			if (iParam0 != -1) {
				return native::is_bit_set(*menu::scr_global(rage::global::_155_player_stats_struct).at(iParam0, rage::global::_155_player_stats_size).at(rage::global::_155_property_int_offset_16).at(rage::global::_155_property_int_offset_16_1).as<int*>(), 2);
			}
		...
		int func_285(int iParam0) {
			if (iParam0 != -1) {
				return  native::is_bit_set(*menu::scr_global(rage::global::_155_property_base2).at(iParam0, rage::global::_155_property_base2_size).at(rage::global::_155_property_base2_flag).as<int*>(), 9);
			}
			return 0;
		}
		...
		bool func_606(int iParam0, bool bParam1) {
			if (*menu::scr_global(rage::global::_155_property_base3).as<int*>() != -1) {
				if (!func_607(*menu::scr_global(rage::global::_155_property_base3).as<int*>())) {
					return 0;
				}

				if (bParam1) {
					if (native::player_id() != *menu::scr_global(rage::global::_155_property_base3).as<int*>()) {
						if (native::is_bit_set(*menu::scr_global(rage::global::_155_property_base2).at(*menu::scr_global(rage::global::_155_property_base3).as<int*>(), rage::global::_155_property_base2_size).at(rage::global::_155_property_base2_flag).as<int*>(), 24) || func_285(*menu::scr_global(rage::global::_155_property_base3).as<int*>())) {
							return 1;
						}
					}
				}
			...
			return  native::is_bit_set(*menu::scr_global(rage::global::_155_property_base2).at(iParam0, rage::global::_155_property_base2_size).at(rage::global::_155_property_base2_flag).as<int*>(), 24);
		}

		// updated
		int func_605(int iParam0, bool bParam1, bool bParam2) {
			if (bParam2) {
				return func_606(native::player_id(), 0);
			}
			if (bParam1) {
				if (func_606(native::player_id(), 0)) {
					return 0;
				}
				switch (iParam0) {
				case 103:
			...
			if (iParam0 == -1) {
				if (iParam1 >= 1) {
					if (func_605(iParam1, 0, 0)) {
						...
						if (*menu::scr_global(rage::global::_155_property_base4).at(iParam1, rage::global::_155_property_base4_size).at(rage::global::_155_property_base4_flag).as<int*>() == 2) {
							if (bParam2) {
								return 3;
							}
							else {
						...
						else if (*menu::scr_global(rage::global::_155_property_base4).at(iParam1, rage::global::_155_property_base4_size).at(rage::global::_155_property_base4_flag).as<int*>() == 6) {
							if (bParam2) {
								return 8;
							}
							else {
						...
						else if (*menu::scr_global(rage::global::_155_property_base4).at(iParam1, rage::global::_155_property_base4_size).at(rage::global::_155_property_base4_flag).as<int*>() == 10) {
							if (bParam2) {
								return 13;
							}
							else {
		...
		void func_1149(int iParam0, int* iParam1, bool bParam2) {
			if (*menu::scr_global(rage::global::_155_tunables).at(rage::global::_155_property_int_offset_17).as<int*>()) {
				*iParam1 = iParam0;
			}

			if (iParam0 >= 0) {
				*iParam1 = (*menu::scr_global(rage::global::_155_property_base5).at(iParam0).as<int*>() - 1);
			}
			else {
				*iParam1 = -1;
			}
		...
		int func_981(int iParam0) {
			if (iParam0 != -1) {
				return *menu::scr_global(rage::global::_155_player_stats_struct).at(iParam0, rage::global::_155_player_stats_size).at(rage::global::_155_property_int_offset_16).at(rage::global::_155_property_int_offset_16_2).as<int*>();
			}
			return 0;
		}
		...
		int func_979(int iParam0) {
			if (iParam0 != -1) {
				return *menu::scr_global(rage::global::_155_player_stats_struct).at(iParam0, rage::global::_155_player_stats_size).at(rage::global::_155_property_int_offset_16).at(rage::global::_155_property_int_offset_16_3).as<int*>();
			}
			return 0;
		}
