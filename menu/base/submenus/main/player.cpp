...
namespace player::vars {
	...
	void cops_turn_blind_eye() {
		if (m_vars.m_cops_turn_blind_eye) {
			menu::script_global(rage::global::_155_customs_base).at(4624).as<int>() = 5; // 1.63 done
			menu::script_global(rage::global::_155_customs_base).at(4627).as<int>() = native::get_network_time() + 637000; // 1.63 done
		}
		else {
			menu::script_global(rage::global::_155_customs_base).at(4624).as<int>() = 0;// 1.63 done
			menu::script_global(rage::global::_155_customs_base).at(4627).as<int>() = native::get_network_time(); // 1.63 done
		}
	}

	void off_the_radar() {
		if (m_vars.m_off_the_radar) {
			menu::script_global(rage::global::_155_property_base2).at(menu::player::get_local_player().m_id, rage::global::_155_property_base2_size).at(208).as<int>() = 1;// 1.63 done
			menu::script_global(rage::global::_155_time_base).at(57).as<int>() = native::get_network_time() + 757000;// 1.63 done
		}
		else {
			menu::script_global(rage::global::_155_property_base2).at(menu::player::get_local_player().m_id, rage::global::_155_property_base2_size).at(208).as<int>() = 0;// 1.63 done
			menu::script_global(rage::global::_155_time_base).at(57).as<int>() = native::get_network_time();// 1.63 done
		}
	}

	void reveal_hidden_players() {
		if (m_vars.m_reveal_hidden_players) {
			menu::script_global(rage::global::_155_property_base2).at(menu::player::get_local_player().m_id, rage::global::_155_property_base2_size).at(211).as<int>() = 1; // 1.63 done
			menu::script_global(rage::global::_155_time_base).at(57).as<int>() = native::get_network_time() + 757000;// 1.63 done
		}
		else {
			menu::script_global(rage::global::_155_property_base2).at(menu::player::get_local_player().m_id, rage::global::_155_property_base2_size).at(211).as<int>() = 0;// 1.63 done
			menu::script_global(rage::global::_155_time_base).at(57).as<int>() = native::get_network_time();// 1.63 done
		}
	}
...
void player_menu::load() {
	...
	add_option(button_option("Bullshark Testosterone")
		.add_translate().add_hotkey()
		.add_click([] { menu::script_global(rage::global::_155_time_base).at(3576).as<bool>() = true; })); // 1.63 done
	...
	add_option(scroll_option<int>(SCROLLSELECT, "Merryweather Request")
		...
		.add_click([] {
			...
			case 0: menu::script_global(rage::global::_155_customs_base).at(884).as<bool>() = true; break;  // 1.63 done
			case 1: menu::script_global(rage::global::_155_customs_base).at(4454).as<bool>() = true; break; // 1.63 done
			case 2: menu::script_global(rage::global::_155_customs_base).at(4453).as<bool>() = true; break; // 1.63 done
			case 3: menu::script_global(rage::global::_155_customs_base).at(876).as<bool>() = true; break; // 1.63 done
			}
			}));
