	...
	void render_sprite(menu::player::player_context& player, int pos) {
		...
		if (blip_handle) {
			...
			if (blip_id > 0 && blip_id != 164) {
				...
				rage::types::grc_texture_dx11* Purge_blip_sprite = rage::engine::get_sprite_texture("PurgeBlips", blip_name);

				if (Purge_blip_sprite && Purge_blip_sprite != invalid_sprite) {
					struct special {
					...
					menu::renderer::draw_sprite({ "PurgeBlips", blip_name },
						{ global::ui::g_position.x + 0.004f + 0.007f, global::ui::g_position.y + (pos * global::ui::g_option_scale) + 0.005f + 0.012f },
		...
		if (!player.m_in_vehicle) {
			menu::renderer::draw_sprite({ "PurgeBlips", "blip_1" },
				{ global::ui::g_position.x + 0.004f + 0.007f, global::ui::g_position.y + (pos * global::ui::g_option_scale) + 0.005f + 0.012f },
