#include "network_global_chat_Purge.h"
#include "menu/base/submenu_handler.h"
#include "../network_global_chat.h"

using namespace network::gchat::Purge::vars;

namespace network::gchat::Purge::vars {
	variables m_vars;
...
void network_global_chat_Purge_menu::load() {
	set_name("Purge Chat");
	set_parent<network_global_chat_menu>();

	add_option(toggle_option("Toggle Purge Chat")
...
void network_global_chat_Purge_menu::update() {}

void network_global_chat_Purge_menu::update_once() {}

void network_global_chat_Purge_menu::feature_update() {}

network_global_chat_Purge_menu* g_instance;
network_global_chat_Purge_menu* network_global_chat_Purge_menu::get() {
	if (g_instance == nullptr) {
		g_instance = new network_global_chat_Purge_menu();
		g_instance->load();
