			...
			add_option(submenu_option(option)
				...
				.add_update([=](submenu_option* option, int pos) {
					...
					if (menu::textures::get_texture(std::string("playerimg_" + std::to_string(session.m_rockstar_id)), &context)) {
						...
						menu::renderer::draw_sprite({ "Purgeplayerimg", context.m_name }, { global::ui::g_position.x + 0.004f + 0.007f, global::ui::g_position.y + (pos * global::ui::g_option_scale) + 0.005f + 0.011f }, { 0.0136f, 0.0216f }, 0.f, { 255, 255, 255, 255 });
					}
				})
